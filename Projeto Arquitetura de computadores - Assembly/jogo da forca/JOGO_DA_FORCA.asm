...
section .data
  ...
  t_msg2 equ $-msg2 
  msg3 db "Digite uma UNICA Letra: "
  t_msg3 equ $-msg3
...
PADRONIZA_CHUTE: ; o chute fica todo em maiusculo
...
loop:
	...
	je livre 
	cmp byte[PalavraChave+esi],'-'	; nao vou bloquear o infem.. eh sacanagem tbmmm
	je livre
...
;------------------------------------ LOOP PRINCIPAL DO JOGO ------------------------------------------
  jogo:
	...
	cmp eax,1
	je jogo						; igual a 2 o tamanho, entao o cara digitou um enter.. a string so tem um '\0'	
	...
	ehLetra:
		...
		;   4 byte/4byte	
		cmp eax,[restante]			; qndo varrer a palavra dnv... eax vai ter a quantidade atual restante de letras a serem desbloqueadas
		je errouu					; se a quantidade atual e igual a quantidade antiga, entao o cara errou, nao desbloqueou nenhuma letra..
