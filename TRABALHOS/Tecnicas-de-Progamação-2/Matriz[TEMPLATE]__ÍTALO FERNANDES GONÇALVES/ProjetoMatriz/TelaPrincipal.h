...
public:
    ...
    void InfMatB()const;
    void InfMatC()const;
    void MostrarResultado(MAT::Matriz<int> const * const R)const;
    void AnaliseMat_X(MAT::Matriz<int> const * const X,int Matriz_X)const;
...
private slots:    
    ...
    void on_comboBox_Operacoes_activated(const QString &arg1);

    void on_comboBox_Operacoes_activated(int index);

    void on_radioButtonModeDinamic_clicked(bool checked);
