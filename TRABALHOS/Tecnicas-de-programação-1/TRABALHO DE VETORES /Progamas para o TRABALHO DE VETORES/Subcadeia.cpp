...
int main()
{
	...
	cont++;
		...
		for(k = i; k < n-1 && A[k] < A[k+1]; k++);// este for e executado enquanto A[K] for menor que A[K+1] , isto e , enquanto formar uma sequencia crescente
